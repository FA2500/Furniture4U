...
import my.fa250.furniture4u.ml.classification.utils.VertexUtils.calculateAverage
import my.fa250.furniture4u.ml.classification.utils.VertexUtils.rotateCoordinates
import my.fa250.furniture4u.ml.classification.utils.VertexUtils.toAbsoluteCoordinates
 ...
 */
class GoogleCloudVisionDetector(val activity: ContextActivity) : ObjectDetector(activity) {
  companion object {
