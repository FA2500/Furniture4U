package my.fa250.furniture4u.ar.render.arcore;
...
public class SpecularCubemapFilter implements Closeable {
     ...
     *
     * <p>This method should be called every frame with the result of getCubeMap to update the filtered
     * cubemap texture, accessible via getCubeMap.
     *
